...
import Item from '@/pages/shop/settlement/componment/item/Item';
import Title from '@/pages/shop/settlement/componment/title/Title';
import '../../../assets/logos/iconfont.css';
import ResultSub from '@/pages/shop/settlement/componment/result/ResultSub';
import PackageItem from '@/pages/shop/settlement/componment/simplepriceitem/PackageItem';
import styles from './Settlement.less';
import { BundleItem } from '@/pages/shop/manage/BundleManager';
import service, { Order } from '@/pages/shop/settlement/service';
...
export default () => {
    ...
    useEffect(() => {
        ...
        const pathPrefix = '/shop/settlement/';
    ...
    const handleToPay = () => {
        ...
        setOrderStatus('generated');
        history.push('/shop/pay/' + order?.id);
    };
